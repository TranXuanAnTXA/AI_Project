...
Mối liên hệ (Dependencies): File này là file "cấp thấp nhất" trong logic AI, không phụ thuộc vào file nào khác trong dự án (chỉ dùng thư viện chuẩn Python). Nó được import bởi tất cả các file chứa thuật toán tìm đường (như pathfinding.py).
"""
